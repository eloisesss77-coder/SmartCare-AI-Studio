...
"use strict";
/* unused harmony export loginReady */
/* harmony import */ var D_SmartCare_AI_Studio_03_Projects_smartcare_monitor_miniapp_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/regenerator.js */ "./node_modules/@babel/runtime/helpers/esm/regenerator.js");
/* harmony import */ var D_SmartCare_AI_Studio_03_Projects_smartcare_monitor_miniapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ "./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js");
...
var loginReady = new Promise(function (resolve) {
...
function App(_ref) {
  ...
  (0,_tarojs_taro__WEBPACK_IMPORTED_MODULE_0__.useLaunch)(/*#__PURE__*/(0,D_SmartCare_AI_Studio_03_Projects_smartcare_monitor_miniapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_3__["default"])(/*#__PURE__*/(0,D_SmartCare_AI_Studio_03_Projects_smartcare_monitor_miniapp_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_4__["default"])().m(function _callee() {
    return (0,D_SmartCare_AI_Studio_03_Projects_smartcare_monitor_miniapp_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_4__["default"])().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          ...
          if (loginResolve) {
            (0,_services_api__WEBPACK_IMPORTED_MODULE_1__.setLoginReady)();
            loginResolve();
            loginResolve = null;
          }
        case 2:
...
function _doLogin() {
  _doLogin = (0,D_SmartCare_AI_Studio_03_Projects_smartcare_monitor_miniapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_3__["default"])(/*#__PURE__*/(0,D_SmartCare_AI_Studio_03_Projects_smartcare_monitor_miniapp_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_4__["default"])().m(function _callee2() {
    var _ret$data, deviceId, res, ret, _t;
    return (0,D_SmartCare_AI_Studio_03_Projects_smartcare_monitor_miniapp_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_4__["default"])().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          deviceId = _tarojs_taro__WEBPACK_IMPORTED_MODULE_0___default().getStorageSync('deviceId');
          if (!deviceId) {
            deviceId = generateUUID();
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_0___default().setStorageSync('deviceId', deviceId);
          }
          _context2.n = 1;
          return _tarojs_taro__WEBPACK_IMPORTED_MODULE_0___default().request({
            ...
            data: {
              openid: deviceId,
              nickname: _tarojs_taro__WEBPACK_IMPORTED_MODULE_0___default().getStorageSync('nickname') || '',
              phone: ''
            }
          });
        case 1:
          res = _context2.v;
          ret = res.data;
          if (ret !== null && ret !== void 0 && (_ret$data = ret.data) !== null && _ret$data !== void 0 && _ret$data.familyId) {
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_0___default().setStorageSync('familyId', ret.data.familyId);
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_0___default().setStorageSync('nickname', ret.data.nickname || '');
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_0___default().setStorageSync('phone', ret.data.phone || '');
...
var config = {"pages":["pages/index/index","pages/elderly-detail/elderly-detail","pages/alert-list/alert-list","pages/alert-detail/alert-detail","pages/bind/bind","pages/mine/mine"],"window":{"backgroundTextStyle":"light","navigationBarBackgroundColor":"#1890ff","navigationBarTitleText":"安伴 Guardian","navigationBarTextStyle":"white","backgroundColor":"#f5f5f5"},"tabBar":{"color":"#999999","selectedColor":"#1890ff","backgroundColor":"#ffffff","borderStyle":"white","list":[{"pagePath":"pages/index/index","text":"🏠 首页"},{"pagePath":"pages/alert-list/alert-list","text":"🔔 告警"},{"pagePath":"pages/mine/mine","text":"👤 我的"}]},"permission":{"scope.userLocation":{"desc":"你的位置信息将用于紧急情况定位"}}};
